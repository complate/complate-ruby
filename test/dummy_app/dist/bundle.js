...
var fancy_jsx = (function (_ref) {
  var text = _ref.text;
  return createElement("span", null, createElement(MyButton, {
    text: text
  }));
});

var renderer = new Renderer('<!DOCTYPE html>');
renderer.registerView(fancy_jsx, 'fancy_jsx');
var complateViewFile20190109675Olksxl = renderer.renderView.bind(renderer);

return complateViewFile20190109675Olksxl;
